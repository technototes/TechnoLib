...
public class RegenerativeTrajectoryCommand extends TrajectoryCommand {
    ...
    public RegenerativeTrajectoryCommand(
            MecanumDrivebaseSubsystem sub, Function<Function<Pose2d, TrajectoryBuilder>, Trajectory> t) {
        super(sub, t);
    ...
    public <T> RegenerativeTrajectoryCommand(
            MecanumDrivebaseSubsystem sub, BiFunction<Function<Pose2d, TrajectoryBuilder>, T, Trajectory> t, T mux) {
        super(sub, t, mux);
